;* --------BEGIN--------
;* C:\Users\Janusz\Desktop\h\h.rmt
FEAT_SFX		equ 0
...
FEAT_AUDCTLMANUALSET		equ 1		;(14 times)
FEAT_VOLUMEMIN		equ 0		;(0 times)
FEAT_EFFECTVIBRATO		equ 0		;(0 times)
FEAT_EFFECTFSHIFT		equ 1		;(3 times)
;* --------END--------
